...
const Dashboard = () => {
  ...
  const handleAddRecipe = async (e) => {
    ...
    try {
      ...
      // "salt, pepper, oil" → ["salt", "pepper", "oil"]
      const ingredientsArray = formData.ingredients
        .split(',')
        .map((i) => i.trim())   // remove spaces around each item
      ...
      // Add new recipe to the top of the list without re-fetching
      setRecipes([data, ...recipes]);
            ...
            <form onSubmit={handleAddRecipe}>
              <div style={styles.formGrid}>
                ...
                <div style={styles.field}>
                  ...
                  <input
                    name="cookingTime" value={formData.cookingTime}
                    onChange={handleChange} style={styles.input}
              ...
              <div key={recipe._id} style={styles.recipeRow}>
                ...
                <div style={styles.recipeInfo}>
                  ...
                  <div style={styles.recipeMeta}>
                    ...
                    <span style={styles.muted}>⏱ {recipe.cookingTime} mins</span>
...
const styles = {
  ...
  formTitle: { fontSize: '1.2rem', fontWeight: '700', marginBottom: '1rem', color: '#1a1a1a' },
  formError: {
  ...
  label: {
    ...
    fontWeight: '500', fontSize: '0.875rem', color: '#444',
  },
  input: {
  ...
  thumbnailPlaceholder: {
    width: '64px', height: '64px',
    borderRadius: '8px', backgroundColor: '#ffeaea',
    display: 'flex', alignItems: 'center',
    justifyContent: 'center', fontSize: '1.5rem', flexShrink: 0,
  },
  recipeInfo: { flex: 1 },
  recipeName: { fontSize: '1rem', fontWeight: '600', color: '#1a1a1a', marginBottom: '0.4rem' },
  ...
  deleteBtn: {
    ...
    border: '1px solid #e74c3c', padding: '6px 14px',
